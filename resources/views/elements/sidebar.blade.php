...
<div class="deznav">
    <div class="deznav-scroll">
		<div class="main-profile">
			...
			<p class="email">rjgabriel@gmail.com</p>
		</div>
		<ul class="metismenu" id="menu">

			<li class="nav-label first">Youk</li>
            <li>
                ...
                <ul aria-expanded="false">
					<li><a href="{!! url('/meu_perfil'); !!}">Perfil</a></li>
					<li><a href="{!! url('/meu_plano'); !!}">Plano</a></li>
					<li><a href="{!! url('/configuracoes'); !!}">Configurações</a></li>
					<li><a href="{!! url('/tranasactions'); !!}">Notas</a></li>
					<li><a href="{!! url('/coin-details'); !!}">Alertas</a></li>
				</ul>
            </li>
		...
		<div class="copyright">
			<p><strong>Dashboard</strong> © 2022 Todos os direitos reservados</p>
			<p class="fs-12">Desenvolvido por <span class="heart"></span> Youk.app</p>
		</div>
	</div>
</div>
<!--**********************************
